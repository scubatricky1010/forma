...
/* profile.html.twig */
class __TwigTemplate_e3a0019ce4e5f807dbb0fc6cecdf89bb5bc6649706bd9f78781bb3d50657ad34 extends Twig_Template
{
...
<div id=\"c-menu--slide-right\" class=\"c-menu c-menu--slide-right user-panel\">
    <div class=\"container-fluid\">
        ...
        <div class=\"tabnav js-tabnav\">
            ";
        // line 23
        if (((isset($context["profile"]) ? $context["profile"] : null) || (isset($context["credits"]) ? $context["credits"] : null))) {
            // line 24
        ...
        if ((isset($context["profile"]) ? $context["profile"] : null)) {
            ...
            echo $this->getAttribute((isset($context["profile"]) ? $context["profile"] : null), "homeUserProfile", array(0 => "normal", 1 => false, 2 => false), "method");
            echo "</div>
        ";
        }
        // line 38
        ...
        if ((isset($context["credits"]) ? $context["credits"] : null)) {
            ...
            // line 42
            echo (isset($context["credits"]) ? $context["credits"] : null);
            echo "</div>
                    </div>
                </div>
            </div>
        ...
        <div class=\"row course-subscription\">
            <div class=\"col-xs-12\">
                ";
        // line 50
        echo (isset($context["subscribeCourse"]) ? $context["subscribeCourse"] : null);
        echo "
            </div>
        </div>
        <div class=\"row news\">
        ...
        ";
        // line 58
        if ((call_user_func_array($this->env->getFunction('evalPhp')->getCallable(), array("count", array(0 => (isset($context["languages"]) ? $context["languages"] : null)))) > 1)) {
            // line 59
...
";
    ...
    {
        return new Twig_Source("", "profile.html.twig", "C:\\Program Files\\Ampps\\www\\templates\\standard\\layout\\appLms\\profile.html.twig");
    }
}
