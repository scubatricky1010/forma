...
class __TwigTemplate_d73e84b02092c2659cf6c9afed523dbb54dd106c8a1a13a78aab513768b89bf2 extends Twig_Template
{
    ...
    <form id=\"contact\" name=\"contact\" action=\"#\" method=\"post\" style=\"width: 470px;\" role=\"form\" style=\"display: block;\">
        ...
        // line 7
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "getIdst", array(), "method"), "html", null, true);
        echo "\">
        ...
        // line 17
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "getUserid", array(), "method"), "html", null, true);
        echo "\" readonly>
                        </div>
                    </td>
                </tr>
        ...
        // line 35
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["userDetails"]) ? $context["userDetails"] : null), call_user_func_array($this->env->getFunction('evalPhp')->getCallable(), array("constant", array(0 => "ACL_INFO_EMAIL"))), array(), "array"), "html", null, true);
        echo "\" placeholder=\"\">
                        </div>
                    </td>
                </tr>
...
";
    ...
    {
        return new Twig_Source("", "helpdesk_modal.html.twig", "C:\\Program Files\\Ampps\\www\\templates\\standard\\layout\\appLms\\helpdesk_modal.html.twig");
    }
}
